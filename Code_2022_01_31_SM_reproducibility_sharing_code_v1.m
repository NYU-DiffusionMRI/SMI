...
Lmax = STARDOM_debug.GetDefaultLmax(bval,bshape,TE);
tic
...
Nlevels=10;
tic
KERNEL = STARDOM_debug.StandardModel_PR_fit_RotInvs(RotInvs,mask,sigma_mf,bval,dirs,bshape,TE,lb_training,ub_training,Lmax_train,Ntraining,Nlevels,[0 0.4]);
t=toc;
fprintf('Time PR training fit %f s\n',t)
